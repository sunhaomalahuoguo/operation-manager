...
if(_6b.total == 0){
	_6d=_6d.replace(/{from}/,_6b.total);	
}else{
	...
	$(".combobox-item", _31).hover(function () {
		...
		if (_30.multiple) {
			if (_34.hasClass("combobox-item-selected")) {
				_6ba(_2d, _34.attr("value"));
			} else {
				_6b0(_2d, _34.attr("value"));
			}
		} else {
			_6b0(_2d, _34.attr("value"));
			$(_2d).combo("hidePanel");
...
_6cf.find("div.combobox-item").remove();
