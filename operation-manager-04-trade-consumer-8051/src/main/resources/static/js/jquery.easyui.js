...
if(!$.support.boxModel&&null!=$.browser&&null!=$.browser.msie){
$(this).width(_e);
}else{
...
node.each(function(){
$(this).remove();
if(null!=$.browser&&null!=$.browser.msie){
this.outerHTML="";
}
});
};
...
var _548=$("<input"+(_547&&_547.maxlength?(" maxlength=\""+_547.maxlength+"\""):"")+" type=\"text\" class=\"datagrid-editable-input\">").appendTo(_546);
return _548;
...
var _55f=$("<input"+(_55e&&_55e.maxlength?(" maxlength=\""+_55e.maxlength+"\""):"")+" type=\"text\" class=\"datagrid-editable-input\">").appendTo(_55d);
_55f.numberbox(_55e);
return _55f;
...
var _568=$("<input"+(_567&&_567.maxlength?(" maxlength=\""+_567.maxlength+"\""):"")+" type=\"text\" class=\"datagrid-editable-input\">").appendTo(_566);
