...
public class MerchantCapitalAlloDetail implements Serializable {
    private Long id;

    private Long alloRecordId;
    ...
    public Long getAlloRecordId() {
        return alloRecordId;
    }

    public void setAlloRecordId(Long alloRecordId) {
        this.alloRecordId = alloRecordId;
    }
    ...
    public String toString() {
        ...
        sb.append(", alloRecordId=").append(alloRecordId);
