...
public class MerchantCapitalAccuRecord implements Serializable {
    private Long id;
    ...
    public Integer getAccuType() {
        return accuType;
    }

    public void setAccuType(Integer accuType) {
    ...
    public String toString() {
        ...
        sb.append(", accuType=").append(accuType);
